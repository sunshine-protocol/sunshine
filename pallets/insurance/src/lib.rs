#![recursion_limit = "256"]
//! # Insurance Module
//! This module expresses two-party dispute resolution with a preset resolver.
//!
...
//! ## Overview
//!
//! This pallet stores vote metadata associated with an on-chain insurance agreement.
//! If a dispute arises, the vote is dispatched s.t. its outcome resolves the dispute
//! and performs the associated transfers.
//!
//! [`Call`]: ./enum.Call.html
