...
pub type Org = org::Module<TestRuntime>;
pub type Vote = vote::Module<TestRuntime>;
pub type Bank = bank::Module<TestRuntime>;
pub type Bounty = Module<TestRuntime>;

fn get_last_event() -> RawEvent<u64, u64, u32, u64, u64, u64, u64> {
    System::events()
        .into_iter()
        .map(|r| r.event)
        .filter_map(|e| {
...
fn genesis_config_works() {
    new_test_ext().execute_with(|| {
        ...
        let expected_organization = Organization::new(Some(1), None, 1738);
